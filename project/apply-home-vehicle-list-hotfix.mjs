...
const component = `import { Component, Input, inject } from "@angular/core";
...
console.log('Homepage rental and sale inventory converted to accessible full-width list rows.');
