...
const migration=read('supabase/migrations/20260825102000_v1632_branch_partner_boundary.sql');
all(migration,['revoke all on table public.branch_partner_requests from anon, authenticated','grant all on table public.branch_partner_requests to service_role','enable row level security'],'branch partner database boundary');
...
console.log('V163.2 branch-partner same-origin, service-role and privacy invariants are satisfied.');
