...
for (const path of [canonicalAdminPath, mediaPath, bookingGatewayPath, pricingMigrationPath, gcMigrationPath, routePath]) {
...
console.log('V200 campaign price/media integrity: PASS');
