...
const port = Number(process.env.V234_PORTABLE_SMOKE_PORT || 4187);
...
async function main() {
  ...
  console.log('V234 portable runtime smoke OK: Node server, SPA admin route, protected admin API alias and catalog-media routing work without Vercel.');
}
