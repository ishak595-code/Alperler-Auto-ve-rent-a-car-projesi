...
export const routes: Routes = [
  ...
  { path: 'admin', loadComponent: () => import('./pages/admin/admin-layout.component').then(m => m.AdminLayoutComponent), canActivate: [adminGuard], children: [
      ...
      { path: 'content', loadComponent: loadAdminContentHub, data: { contentSection: 'catalog' }, canActivate: [adminAreaGuard('content')] },
      { path: 'catalog-editor', loadComponent: loadAdminContentHub, data: { contentSection: 'catalog' }, canActivate: [adminAreaGuard('content')] },
      ...
      { path: 'media', loadComponent: loadAdminContentHub, data: { contentSection: 'catalog' }, canActivate: [adminAreaGuard('content')] },
      { path: 'cars', loadComponent: loadAdminContentHub, data: { contentSection: 'catalog' }, canActivate: [adminAreaGuard('content')] },
      { path: 'sales', loadComponent: loadAdminContentHub, data: { contentSection: 'catalog' }, canActivate: [adminAreaGuard('content')] },
      { path: 'tours', loadComponent: loadAdminContentHub, data: { contentSection: 'catalog' }, canActivate: [adminAreaGuard('content')] },
