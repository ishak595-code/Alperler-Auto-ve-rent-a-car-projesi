...
@Component({
  ...
  `,
  styles: [`
    :host{display:block;min-width:0}.date-control{display:block;min-width:0}.date-label{display:block;margin-bottom:.38rem;color:var(--date-label,var(--alper-muted,#b9c3d2));font-size:.66rem;font-weight:900;letter-spacing:.06em;text-transform:uppercase}.date-surface{position:relative;display:flex;width:100%;min-height:52px;align-items:center;justify-content:space-between;gap:.7rem;overflow:hidden;border:1px solid var(--date-border,var(--alper-border,rgba(148,163,184,.24)));border-radius:min(var(--site-radius,12px),16px);background:var(--date-bg,var(--alper-card,#050c1a));padding:.58rem .78rem .58rem .9rem;color:var(--date-color,var(--alper-text,#fff));text-align:left;cursor:pointer}.date-surface:focus-within{border-color:var(--date-focus,var(--alper-blue-light,#60a5fa));box-shadow:0 0 0 3px color-mix(in srgb,var(--date-focus,var(--alper-blue-light,#60a5fa)) 20%,transparent)}.date-surface.disabled{cursor:not-allowed;opacity:.55}.button-copy{display:block;min-width:0;pointer-events:none}.button-copy strong,.button-copy small{display:block}.button-copy strong{font:900 .8rem/1.2 ui-sans-serif,system-ui,sans-serif}.button-copy small{margin-top:.18rem;color:var(--date-hint,var(--alper-subtle,#8f9db0));font:700 .66rem/1.25 ui-sans-serif,system-ui,sans-serif}.date-surface mat-icon{flex:0 0 auto;color:var(--date-icon,var(--alper-blue-light,#93c5fd));pointer-events:none}.native-date-control{position:absolute!important;inset:0!important;z-index:2;width:100%!important;height:100%!important;min-height:100%!important;margin:0!important;border:0!important;border-radius:inherit!important;padding:0!important;background:transparent!important;color:transparent!important;-webkit-text-fill-color:transparent!important;font-size:0!important;caret-color:transparent!important;cursor:pointer;touch-action:manipulation}.native-date-control:focus{outline:0}.native-date-control:disabled{cursor:not-allowed}@media(prefers-reduced-motion:reduce){.date-surface{transition:none!important}}
  `],
})
