            ...
            @if (footer.settings().showSocial) {
              <nav class="social-row" aria-label="Sosyal medya hesapları">
                @for (social of socialLinks(); track social.name) {
                  @if (social.url) {
                    <a [href]="social.url" target="_blank" rel="noopener noreferrer" class="social-link" [attr.aria-label]="social.name + ' hesabını aç'" [title]="social.name"><span class="social-icon" [style.--icon-url]="'url(' + social.icon + ')'" aria-hidden="true"></span></a>
                  } @else {
                    <span class="social-link disabled" aria-disabled="true" [attr.aria-label]="social.name + ' bağlantısı henüz eklenmedi'" [title]="social.name + ' bağlantısı henüz eklenmedi'"><span class="social-icon" [style.--icon-url]="'url(' + social.icon + ')'" aria-hidden="true"></span></span>
                  }
                }
              </nav>
            }
