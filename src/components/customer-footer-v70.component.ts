        ...
        <div class="footer-shell">
          <section class="brand-column" aria-labelledby="footer-brand-title">
            ...
            @if (footer.settings().showSocial && socialLinks().length) {
              <nav class="social-row" aria-label="Sosyal medya hesapları">@for (social of socialLinks(); track social.name) { <a [href]="social.url" target="_blank" rel="noopener noreferrer" class="social-link" [attr.aria-label]="social.name + ' hesabını aç'" [title]="social.name"><span class="social-icon" [style.--icon-url]="'url(' + social.icon + ')'" aria-hidden="true"></span></a> }</nav>
            }
          </section>
