      ...
      <footer class="customer-footer" aria-label="Alperler Auto alt bilgi">
        <div class="footer-shell">
          <section class="brand-column" aria-labelledby="footer-brand-title">
            ...
            @if (footer.settings().showSocial && socialLinks().length > 0) {
  ...
  private safeSocialUrl(value:string|undefined):string{
    ...
    try{
      ...
      if(host==='instagram.com'||host.endsWith('.instagram.com')){
        ...
        if(parts.length>0)url.pathname=`/${parts[0]}/`;
        url.search='';
      }
      return url.toString();
    }catch{return'';}
