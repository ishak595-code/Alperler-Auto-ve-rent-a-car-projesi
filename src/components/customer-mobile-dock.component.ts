...
@Component({
  ...
  template: `
    @if (!hidden()) {
      <nav class="customer-command-dock xl:hidden" aria-label="Mobil hızlı navigasyon">
        <a
          routerLink="/fleet"
          routerLinkActive="dock-active"
          class="dock-action"
          aria-label="Kiralık araçları aç"
        >
        ...
        <a
          ...
          routerLinkActive="dock-active"
          class="dock-action"
          aria-label="Satılık araçları aç"
        >
