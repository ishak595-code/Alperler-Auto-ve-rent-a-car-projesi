          ...
          @if (renderer() === 'PARTNER') {
            <div class="partner-card">
              <div class="partner-copy">
                @if (profileImage()) { <img class="section-profile" [src]="profileImage()" [alt]="section.title + ' profil görseli'" loading="lazy" /> }
