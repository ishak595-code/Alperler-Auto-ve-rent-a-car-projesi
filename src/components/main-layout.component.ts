...
@Component({
  ...
  template: `
    <div class="min-h-screen flex flex-col font-sans relative bg-slate-50">
      ...
      <main class="flex-grow pt-[80px] md:pt-[96px]">
      ...
      <!-- WhatsApp Float Button (Appears after 15 seconds) -->
      @if (showWhatsapp()) {
        <a
          [href]="
            'https://wa.me/' +
          ...
          class="fixed bottom-4 right-4 z-[90] w-11 h-11 bg-green-500 text-white rounded-full flex items-center justify-center shadow-md active:scale-90 hover:scale-110 hover:shadow-lg transition-all hover:bg-green-600 animate-fade-in-up"
...
export class MainLayoutComponent {
  ...
  constructor() {
    ...
    // Show WhatsApp after 15 seconds
