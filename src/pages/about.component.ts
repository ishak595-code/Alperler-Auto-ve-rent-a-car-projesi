...
@Component({
  ...
  `,
  styles: [`
    :host{display:block}.about-root{min-height:100vh;background:var(--alper-bg,#06080D);color:var(--alper-text,#F8F6F1)}.module-head{position:sticky;top:0;z-index:45;border-bottom:1px solid rgba(148,163,184,.15);background:rgba(3,8,23,.96);color:#fff;backdrop-filter:blur(16px)}.head-inner{width:min(100% - 1.5rem,80rem);min-height:64px;margin:auto;display:flex;align-items:center;gap:.7rem}.back-button{display:grid;width:44px;height:44px;place-items:center;border:0;border-radius:12px;background:#101a2e;color:#fff}.head-inner p{margin:0;color:var(--alper-blue-light);font-size:.58rem;font-weight:950;letter-spacing:.14em;text-transform:uppercase}.head-inner h1{margin:.1rem 0 0;font-size:.9rem}.hero{position:relative;isolation:isolate;overflow:hidden;background:linear-gradient(135deg,#020617,#071426 58%,#0b1b34);color:#fff}.hero-glow{position:absolute;inset:0;z-index:-1;background:radial-gradient(circle at 78% 20%,rgba(37,99,235,.34),transparent 30%),radial-gradient(circle at 18% 90%,rgba(14,165,233,.17),transparent 34%)}.hero-inner{width:min(100% - 1.5rem,80rem);margin:auto;padding:4rem 0 4.5rem}.eyebrow{margin:0;color:var(--alper-gold,#D4AF37);font-size:.75rem;font-weight:800;letter-spacing:.14em;text-transform:uppercase}.eyebrow.dark{color:var(--alper-gold,#D4AF37)}.hero h2{max-width:900px;margin:.8rem 0 0;font-family:"Playfair Display",Georgia,"Times New Roman",serif;font-size:clamp(2rem,1.4rem + 3.05vw,4.5rem);line-height:1.02;letter-spacing:-.035em}.hero-copy{max-width:700px;margin:1rem 0 0;color:#cbd5e1;font-size:clamp(.92rem,2vw,1.12rem);line-height:1.7}.hero-actions{display:flex;flex-wrap:wrap;gap:.65rem;margin-top:1.5rem}.hero-actions a{display:inline-flex;min-height:48px;align-items:center;border:1px solid rgba(255,255,255,.18);border-radius:12px;background:rgba(255,255,255,.07);padding:0 1rem;color:#fff;font-size:.875rem;font-weight:900;text-decoration:none}.story{background:var(--alper-list,#090C12)}.story-inner,.section-inner{width:min(100% - 1.5rem,80rem);margin:auto;padding:3.25rem 0}.story-inner{display:grid;gap:1.5rem}.story-heading h2,.section-heading h2,.closing h2{margin:.4rem 0 0;font-family:"Playfair Display",Georgia,"Times New Roman",serif;font-weight:600;font-size:clamp(1.75rem,1.3rem + 2.2vw,3.1rem);line-height:1.05;letter-spacing:-.025em}.story-copy{white-space:pre-line;color:var(--alper-muted,#B8B4AA);font-size:.9rem;line-height:1.8}.solutions{background:var(--alper-bg,#06080D)}.section-heading{max-width:760px}.section-heading>p:not(.eyebrow){color:var(--alper-muted,#B8B4AA);line-height:1.6}.solution-grid{display:grid;gap:.8rem;margin-top:1.5rem}.solution-grid article{border:1px solid rgba(212,175,55,.18);border-radius:20px;background:linear-gradient(145deg,var(--alper-card,#11161E),var(--alper-surface,#0D1118));padding:1.25rem;box-shadow:0 18px 40px rgba(0,0,0,.28),inset 0 1px 0 rgba(255,255,255,.04)}.solution-grid article>span{display:grid;width:44px;height:44px;place-items:center;border-radius:13px;background:color-mix(in srgb,var(--alper-gold,#D4AF37) 16%,transparent);color:var(--alper-gold,#D4AF37)}.solution-grid h3{margin:.8rem 0 .35rem;color:var(--alper-text,#F8F6F1);font-size:1.0625rem}.solution-grid p{margin:0;color:var(--alper-muted,#B8B4AA);font-size:.78rem;line-height:1.6}.solution-grid a{display:inline-flex;min-height:44px;align-items:center;gap:.3rem;margin-top:.5rem;color:#F3D77A;font-size:.875rem;font-weight:800;text-decoration:none}.team-section{background:#050b18;color:#fff}.section-heading.center{text-align:center;margin:auto}.team-section .section-heading>p:not(.eyebrow){color:#94a3b8}.team-grid{display:grid;gap:.8rem;margin-top:1.7rem}.team-card{border:1px solid rgba(148,163,184,.14);border-radius:20px;background:#0c1628;padding:1.25rem;text-align:center}.team-card img,.initials{width:82px;height:82px;margin:auto;border-radius:999px}.team-card img{object-fit:cover}.initials{display:grid;place-items:center;background:linear-gradient(145deg,#9E1B24,#9E1B24);color:#fff;font:900 1.25rem/1 Georgia,serif;box-shadow:0 15px 34px rgba(37,99,235,.25)}.team-card h3{margin:.9rem 0 .25rem;font-family:Georgia,"Times New Roman",serif;font-size:1.15rem}.team-card .role{margin:0;color:var(--alper-blue-light);font-size:.65rem;font-weight:900;text-transform:uppercase;letter-spacing:.07em}.team-card .description{margin:.65rem 0 0;color:#94a3b8;font-size:.75rem;line-height:1.55}.closing{width:min(100% - 1.5rem,80rem);margin:2rem auto;display:grid;gap:1rem;border-radius:24px;background:linear-gradient(135deg,#0f172a,#071426);padding:1.5rem;color:#fff}.closing p:not(.eyebrow){max-width:700px;margin:.6rem 0 0;color:#a8b4c7;font-size:.82rem;line-height:1.6}.closing a{display:flex;min-height:48px;align-items:center;justify-content:center;gap:.25rem;border-radius:12px;background:linear-gradient(145deg,#C8212D,#8A111A 56%,#620A10);padding:0 1.1rem;color:#fff;font-size:.9375rem;font-weight:950;text-decoration:none}.closing mat-icon{width:17px;height:17px;font-size:17px}@media(min-width:700px){.story-inner{grid-template-columns:.9fr 1.1fr;gap:3rem}.solution-grid{grid-template-columns:repeat(3,minmax(0,1fr))}.team-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.closing{grid-template-columns:1fr auto;align-items:center;padding:2rem}.closing a{padding:0 1.35rem}}@media(min-width:1050px){.team-grid{grid-template-columns:repeat(4,minmax(0,1fr))}.hero-inner{padding:6rem 0 6.5rem}}
  `],
})
