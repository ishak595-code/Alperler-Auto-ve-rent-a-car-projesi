...
@Component({
    ...
    <main class="account-shell">
      ...
      <section class="account-content" aria-live="polite">
        @switch (section()) {
          ...
          @case ('referral') { <app-account-referral-v241></app-account-referral-v241> }
          @default {
  ...
  `,
  styles:[`
    :host{display:block;background:#060a12}.account-shell{min-height:100vh;background:#060a12;color:#f4f6f8}.account-toolbar{width:min(100%,1180px);margin:auto;padding:clamp(14px,3vw,24px) clamp(14px,3vw,34px) 10px}.home-link{display:inline-flex;min-height:42px;align-items:center;gap:.45rem;border:1px solid #263548;border-radius:12px;background:#0b1420;padding:0 .85rem;color:#dbe7f5;text-decoration:none;font-size:.72rem;font-weight:900}.home-link:focus-visible,.account-shortcuts a:focus-visible,.quick-actions a:focus-visible{outline:3px solid #E15A62;outline-offset:3px}.account-shortcuts{display:flex;width:100%;gap:.55rem;overflow-x:auto;border-block:1px solid #263548;background:#07101b;padding:10px max(14px,calc((100vw - 1180px)/2 + 14px));scrollbar-width:none}.account-shortcuts::-webkit-scrollbar{display:none}.account-shortcuts a{display:inline-flex;min-height:44px;flex:0 0 auto;align-items:center;border:1px solid #304158;border-radius:12px;background:#0d1724;padding:0 14px;color:#dce6f2;text-decoration:none;font-size:.7rem;font-weight:900}.account-shortcuts a.active{border-color:#54779c;background:#13263a;color:#fff;box-shadow:inset 0 0 0 1px rgba(96,165,250,.12)}.account-content{padding-top:18px}.account-content>app-account-referral-v241{display:block;width:min(100% - 28px,1180px);margin:0 auto;padding-bottom:calc(110px + env(safe-area-inset-bottom))}.overview-extras{display:grid;width:min(100% - 28px,1180px);margin:0 auto;gap:.85rem;padding-bottom:calc(110px + env(safe-area-inset-bottom))}.quick-actions{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:.55rem}.quick-actions a{min-width:0;border:1px solid #27364a;border-radius:14px;background:#0b1420;padding:.78rem;color:#fff;text-decoration:none}.quick-actions small,.quick-actions strong,.quick-actions span{display:block}.quick-actions small{color:#c6a15b;font-size:.5rem;font-weight:950;letter-spacing:.08em}.quick-actions strong{margin-top:.18rem;font-size:.75rem}.quick-actions span{margin-top:.2rem;color:#8796a8;font-size:.56rem;line-height:1.35}:host ::ng-deep app-account-dashboard-v150 .account-tools,:host ::ng-deep app-account-dashboard-v150 app-account-referral-v238,:host ::ng-deep app-account-dashboard-v150 .header-actions .logout,:host ::ng-deep app-account-dashboard-v150 .header-actions>a{display:none!important}@media(max-width:720px){.quick-actions{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:620px){.account-toolbar,.account-shortcuts{padding-inline:14px}}
  `]
})
