...
@Component({
  ...
  `,
  styles: [`
    .card{border:1px solid #e2e8f0;border-radius:18px;background:white;padding:1.15rem;box-shadow:0 5px 18px rgba(15,23,42,.04)}.card-head{display:flex;align-items:start;justify-content:space-between;gap:1rem}.card h2{margin-top:.15rem;font-size:1.1rem;font-weight:900}.kicker{font-size:.62rem;font-weight:900;letter-spacing:.1em;text-transform:uppercase;color:var(--alper-blue)}.check-row{display:grid;grid-template-columns:auto 1fr auto;align-items:center;gap:.65rem;border-radius:12px;background:#f8fafc;padding:.6rem}.check-row strong{font-size:.78rem}.check-row p{margin-top:.12rem;font-size:.62rem;color:#94a3b8}.check-row>span{font-size:.62rem;font-weight:900;color:#64748b}.field-label{display:block;margin-bottom:.35rem;font-size:.62rem;font-weight:900;text-transform:uppercase;letter-spacing:.07em;color:#64748b}.field{min-height:48px;width:100%;border:1px solid #cbd5e1;border-radius:12px;background:white;padding:0 .8rem;outline:none}.field:focus{border-color:#3b82f6;box-shadow:0 0 0 3px rgba(59,130,246,.12)}.primary,.success-action,.danger-action,.light-action,.approve,.reject,.neutral{display:flex;align-items:center;justify-content:center;border-radius:12px;font-weight:900}.primary{min-height:48px;background:var(--alper-blue);padding:0 1rem;color:white}.success-action{min-height:44px;background:#059669;padding:0 1rem;color:white}.danger-action{min-height:44px;background:#be123c;padding:0 1rem;color:white}.light-action{min-height:44px;background:white;padding:0 1rem;color:#0f172a}.approve,.reject,.neutral{min-height:42px;padding:0 .7rem;font-size:.72rem}.approve{background:#ecfdf5;color:#047857}.reject{background:#fff1f2;color:#be123c}.neutral{background:#f1f5f9;color:#334155}
  `],
})
