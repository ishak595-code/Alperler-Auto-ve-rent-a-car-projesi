...
export class AdminLayoutComponent {
  ...
  readonly navGroups: AdminNavGroup[] = [
    ...
    { label: "Araç ve İçerik", items: [
      { label: "Araç & Tur Yayın Stüdyosu", route: "/admin/catalog-editor", icon: "03" },
      { label: "Fotoğraf ve Video", route: "/admin/media", icon: "04" },
      { label: "Turlar", route: "/admin/tours", icon: "05" },
      { label: "Kampanyalar", route: "/admin/campaigns", icon: "06" },
      { label: "Blog", route: "/admin/blog", icon: "07" },
    ]},
    { label: "Operasyon", items: [
      { label: "Rezervasyonlar", route: "/admin/reservations", icon: "08" },
      { label: "Partner Başvuruları", route: "/admin/partner-requests", icon: "09" },
      { label: "Geri Bildirim", route: "/admin/feedback", icon: "10" },
      { label: "Aboneler", route: "/admin/subscribers", icon: "11" },
    ]},
    { label: "Organizasyon", items: [
      { label: "Yöneticiler ve Çalışanlar", route: "/admin/team", icon: "12" },
      { label: "Yetki Matrisi", route: "/admin/permissions", icon: "13" },
      { label: "Şubeler", route: "/admin/branches", icon: "14" },
    ]},
    { label: "Sistem", items: [
      { label: "WhatsApp Ayarları", route: "/admin/whatsapp", icon: "15" },
      { label: "Genel Ayarlar", route: "/admin/settings", icon: "16" },
    ]},
  ];
  ...
  private readonly titles: Record<string, string> = {
    ...
    "/admin/catalog-editor": "Araç & Tur Yayın Stüdyosu",
    ...
    "/admin/cars": "Eski Araç Editörü",
    "/admin/reservations": "Rezervasyon Yönetimi",
    "/admin/sales": "Eski Satılık Araç Editörü",
