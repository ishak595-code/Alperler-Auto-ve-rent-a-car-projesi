...
export class AdminLayoutComponent {
  ...
  readonly modules: AdminModuleItem[] = [
    ...
    { id:'operations', route:'/admin/operations', label:'Operasyon & Filo', description:'Rezervasyon, müşteri işlemleri, şubeler ve gerçek araç takibi', icon:'▣', paths:['/admin/operations','/admin/reservations','/admin/partner-requests','/admin/branch-partner-requests','/admin/feedback','/admin/subscribers','/admin/branches','/admin/branch-network','/admin/telematics'] },
