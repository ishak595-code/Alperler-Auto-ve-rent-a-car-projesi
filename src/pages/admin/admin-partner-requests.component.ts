        ...
        <div class="mx-auto flex max-w-7xl flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div class="flex items-center gap-3">
            <button
              ...
              class="flex min-h-12 min-w-12 items-center justify-center rounded-xl bg-slate-100 text-xl font-black text-slate-700 hover:bg-slate-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#E15A62]"
            >
              ←
            </button>
            <div>
          ...
          <div class="grid w-full gap-2 lg:w-auto lg:grid-cols-[minmax(240px,1fr)_180px_auto]">
            <input [ngModel]="searchQuery()" (ngModelChange)="searchQuery.set($event)" type="search" autocomplete="off" placeholder="Müşteri, telefon, araç ara…" aria-label="Araç başvurularında ara" class="min-h-12 rounded-xl border border-slate-200 bg-slate-50 px-4 text-sm font-semibold outline-none focus:border-[#E15A62]" />
                  ...
                  <aside class="w-full space-y-3 xl:w-80">
                    ...
                    <label class="block">
                      ...
                      <textarea
                        ...
                        class="mt-1 w-full rounded-xl border border-slate-200 bg-slate-50 p-3 text-sm outline-none focus:border-[#E15A62] focus:bg-white disabled:opacity-50"
