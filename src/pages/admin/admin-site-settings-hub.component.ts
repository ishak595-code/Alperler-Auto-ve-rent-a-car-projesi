...
@Component({
  ...
  `,
  styles:[`
    :host{display:block;min-height:100vh;background:#f8fafc;color:#0f172a}.workspace{min-height:100vh}.workspace-head{position:sticky;top:0;z-index:80;border-bottom:1px solid #e2e8f0;background:rgba(248,250,252,.97);padding:.45rem 3.4rem .45rem .7rem;box-shadow:0 4px 14px rgba(15,23,42,.05);backdrop-filter:blur(12px)}.head-row{display:flex;width:min(100%,1240px);margin:auto;align-items:center;gap:.6rem}.back{display:grid;width:38px;height:38px;flex:none;place-items:center;border:1px solid #dbe4ef;border-radius:10px;background:#fff;color:#0f172a;font-size:1.05rem;font-weight:950}.head-row h1{margin:0;font-size:1.05rem;font-weight:950;color:#0f172a;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.tabs{display:flex;width:min(100%,1240px);margin:.4rem auto 0;gap:.35rem;overflow-x:auto;scrollbar-width:none;-webkit-overflow-scrolling:touch}.tabs::-webkit-scrollbar{display:none}.tabs button{min-height:36px;flex:0 0 auto;border:1px solid #e2e8f0;border-radius:10px;background:#fff;padding:0 .75rem;color:#475569;font-size:.7rem;font-weight:900}.tabs button strong,.tabs button small{display:block}.tabs button strong{font-size:.67rem;font-weight:950}.tabs button small{margin-top:.15rem;color:#64748b;font-size:.54rem;line-height:1.25}.tabs button.active{border-color:var(--alper-blue);background:#eff6ff;color:var(--alper-blue)}.tabs button:focus-visible{outline:2px solid #9E1B24;outline-offset:2px}.content{min-height:70vh}.accordion-stack{display:grid;width:min(100% - 24px,1000px);margin:16px auto 28px;gap:.55rem}.general-extra{margin-top:-10px}.accordion{overflow:hidden;border:1px solid #dbe4ef;border-radius:15px;background:#fff}.accordion>button{display:flex;width:100%;min-height:70px;align-items:center;justify-content:space-between;gap:1rem;border:0;background:#fff;padding:13px 14px;color:#0f172a;text-align:left}.accordion>button strong,.accordion>button small{display:block}.accordion>button strong{font-size:.78rem;font-weight:950}.accordion>button small{margin-top:.2rem;color:#64748b;font-size:.58rem;line-height:1.4}.accordion>button b{flex:none;color:#64748b;font-size:1.2rem}.accordion-body{border-top:1px solid #e2e8f0}.loading{padding:2rem;text-align:center;color:#64748b;font-size:.7rem;font-weight:850}:host ::ng-deep .content>app-admin-seo-settings>main>header.sticky,:host ::ng-deep .content>app-admin-faq-management>main>header.sticky,:host ::ng-deep .content app-admin-homepage .sticky.top-0,:host ::ng-deep .content>app-admin-legal-center .sticky.top-0,:host ::ng-deep .content .sticky.top-16{position:static!important;top:auto!important}.back:focus-visible,.tabs button:focus-visible,.accordion>button:focus-visible{outline:3px solid #9E1B24;outline-offset:3px}@media(max-width:520px){.workspace-head{padding-left:.7rem;padding-right:3.5rem}.head-row h1{font-size:1.25rem}.tabs button{min-width:118px}}
  `]
})
