    ...
    <div class="settings-workspace">
      <header class="settings-header">
        <div class="title-row">
          ...
          <button type="button" class="menu-button" (click)="openAdminMenu()" aria-label="Ana yönetim menüsünü aç">⋮</button>
        </div>
...
export class AdminSiteSettingsHubComponent implements OnInit {
  ...
  openAdminMenu(): void {
    ...
    const button = document.querySelector<HTMLButtonElement>('.edge-menu-button');
    button?.click();
  }
