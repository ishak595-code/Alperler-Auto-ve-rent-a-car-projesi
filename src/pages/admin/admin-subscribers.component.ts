...
@Component({
  ...
  styles: [`
    ...
    .field{display:flex;flex-direction:column;gap:.4rem;font-size:.72rem;font-weight:900;text-transform:uppercase;letter-spacing:.05em;color:#475569}.control{min-height:46px;width:100%;border:1px solid #cbd5e1;border-radius:12px;background:#fff;padding:.7rem .85rem;color:#0f172a;font-size:.86rem;font-weight:650;outline:none}.control:focus{border-color:#9E1B24;box-shadow:0 0 0 3px rgba(37,99,235,.12)}.action-btn{display:inline-flex;min-height:40px;align-items:center;justify-content:center;gap:.35rem;border-radius:10px;padding:.5rem .75rem;font-size:.72rem;font-weight:900}.action-btn mat-icon{width:16px;height:16px;font-size:16px}
  `],
})
