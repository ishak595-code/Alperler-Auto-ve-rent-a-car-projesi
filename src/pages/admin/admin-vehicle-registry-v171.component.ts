...
</main>`,styles:[`.field{min-height:46px;width:100%;border:1px solid #cbd5e1;border-radius:12px;background:#fff;padding:.65rem .75rem;outline:none}.field:focus{border-color:#9E1B24;box-shadow:0 0 0 3px rgba(37,99,235,.13)}.admin-date{--date-bg:#fff;--date-color:#0f172a;--date-label:#475569;--date-border:#cbd5e1;--date-hint:#64748b;--date-icon:#9E1B24;--date-focus:#9E1B24}.badge{border-radius:999px;background:#f1f5f9;padding:.3rem .55rem;font-size:.65rem;font-weight:900;color:#475569}.data{border:1px solid #e2e8f0;border-radius:14px;background:#f8fafc;padding:.8rem}.data span{display:block;font-size:.62rem;font-weight:900;text-transform:uppercase;color:#64748b}.data strong{display:block;margin-top:.3rem;overflow-wrap:anywhere}`]})
