          ...
          <div class="mt-16 pt-8 border-t border-slate-200 flex flex-col gap-6">
            <div class="bg-slate-50 p-6 rounded-xl border border-slate-100 text-center">
              ...
              <div class="flex justify-center gap-4">
                ...
                <button (click)="copyLink()" class="flex items-center bg-slate-900 hover:bg-blue-500 hover:text-slate-900 text-white px-6 py-3 rounded-full font-bold shadow-lg transition-all transform hover:scale-105">
            ...
            <div class="flex justify-between items-center">
              ...
              <button (click)="openContact()" class="bg-slate-900 text-white px-6 py-3 rounded-sm font-bold uppercase tracking-widest text-xs hover:bg-blue-500 hover:text-slate-900 transition-colors shadow-lg">Hemen İletişime Geçin</button>
            </div>
          </div>
        </div>
      } @else {
