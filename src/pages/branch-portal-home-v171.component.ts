...
@Component({
  ...
  template:`
    <main class="min-h-screen bg-slate-100 pb-20 text-slate-900">
      <header class="border-b border-slate-200 bg-white"><div class="mx-auto flex min-h-16 max-w-7xl items-center justify-between gap-3 px-4 md:px-8"><div><p class="text-[10px] font-black uppercase tracking-[.16em] text-[#9E1B24]">Alperler Auto Şube Portalı</p><h1 class="text-lg font-black">Şube Kontrol Merkezi</h1></div><a routerLink="/" class="rounded-xl border border-slate-200 px-4 py-2 text-sm font-black no-underline">Ana Site</a></div></header>
