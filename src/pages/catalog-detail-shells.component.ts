...
import { TourDetailV169Component } from "./tour-detail-v169.component";
...
@Component({ selector: "app-tour-detail-shell", standalone: true, imports: [TourDetailV169Component], template: `<app-tour-detail-v169 />` })
