...
Alperler Rent A Car’ın kurucusu İshak Alper’dir. Amacımız gerçek araç ve güncel bilgiyi göstermek, müşterinin ihtiyacını hızlı anlamak, talebi kayıt altına almak ve rezervasyon, teslim, ödeme ve operasyon süreçlerini izlenebilir hale getirmektir.`,
  ...
  homeContent: {
    heroTrustLine: "YÜKSEKOVA · KİRALAMA · SATIŞ · TUR · TRANSFER",
    heroTitle: "Doğru aracı bulun, yolculuğunuzu güvenle planlayın.",
    heroSubtitle: "Yüksekova ve Hakkâri çevresinde kiralama, ikinci el araç, şoförlü transfer, özel gün aracı ve yerel tur seçeneklerini tek ekranda karşılaştırın. Fiyatı, temel özellikleri ve hizmet kapsamını görün; size uygun seçeneği açıp rezervasyon, görüşme veya tur talebinizi doğrudan oluşturun.",
    ...
    bookingSubtitle: "Hizmet türünü, tarihi ve teslim noktasını seçin. Uygun seçenekleri doğrudan görüntüleyin.",
    plannerKicker: "HIZLI PLANLAMA",
    plannerNote: "Talep ücretsizdir. Kesin rezervasyon, araç ve tarih uygunluğu doğrulandıktan sonra oluşur.",
