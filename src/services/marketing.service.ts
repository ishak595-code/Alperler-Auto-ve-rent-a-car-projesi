...
export class MarketingService {
  ...
  private readonly endpoint = '/api/partner?op=marketing-admin';
  ...
  private async headers() {
    ...
    return { authorization: `Bearer ${token}`, 'content-type': 'application/json', 'x-request-id': crypto.randomUUID() };
  }
