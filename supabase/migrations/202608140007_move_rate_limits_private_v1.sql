alter table public.api_rate_limits set schema private;
alter table private.api_rate_limits disable row level security;
...
begin
  ...
  insert into private.api_rate_limits(key_hash, scope, window_start, request_count, updated_at)
