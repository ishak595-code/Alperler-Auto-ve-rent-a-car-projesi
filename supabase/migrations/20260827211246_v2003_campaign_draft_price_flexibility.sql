...
alter table public.campaigns
  add constraint campaigns_display_price_matches_authoritative_v2003
  check (
...
alter table public.campaigns validate constraint campaigns_display_price_matches_authoritative_v2003;
